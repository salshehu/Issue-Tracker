...
const seedDevDb = async () => {
  ...
  await prisma.developers.createMany({
    data: [
      ...
      {
        userName: "adjoa_smart",
        firstName: "Adjoa",
        lastName: "Afeku",
        email: "asmartjoa@tmail.com",
      },
      {
        userName: "forgive_99",
        firstName: "Forgive",
        lastName: "Delalivor",
        email: "delagive@ymail.com",
      },
      {
        userName: "dev_simpa",
        firstName: "Sampana",
        lastName: "Amuzu",
        email: "samuzu22@qmail.com",
      },
      {
        userName: "brigdet",
        firstName: "Bridget",
        lastName: "Bansa",
        email: "bb_89@ymail.com",
      },
      {
        userName: "k_ofori",
        firstName: "Kenyasi",
        lastName: "Ofori",
        email: "koforibox@ymail.com",
      },
      {
        userName: "alade_smith",
        firstName: "Yemi",
        lastName: "Alade-Smith",
        email: "ysmith@ymail.com",
      },
      {
        userName: "kumar_khan",
        firstName: "Kumaridran",
        lastName: "Khan",
        email: "kkhan@smail.com",
      },
      {
        userName: "k_lumumba",
        firstName: "Kenyatta",
        lastName: "Lumumba",
        email: "lumba@kmail.com",
      },
      {
        userName: "faris_j",
        firstName: "Faris",
        lastName: "Abdul-Jelil",
        email: "faj@vmail.com",
      },
      {
        ...
        firstName: "Afolabi",
        lastName: "Owolade",
        email: "afolade@ymail.com",
      },
      {
        userName: "sumaila",
        firstName: "Sumaila",
        lastName: "Paintsil",
        email: "supain@fmail.com",
      },
      {
        userName: "Yofi_Ganyo",
        firstName: "Yofi",
        lastName: "Ganyo",
        email: "yganyo23@ymail.com",
      },
    ],
  });
};
